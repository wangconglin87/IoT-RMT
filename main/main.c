...
// MQTT
#define MQTT_SUB_TOPIC "home/room/bed/rmt/yapof"
...
static void rmt_start(ir_gree_scan_code_t *scan_code)
{
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        if (event->data_len == sizeof(ir_gree_scan_code_t)) {
            ir_gree_scan_code_t *scan_code = (ir_gree_scan_code_t*) event->data;
            rmt_start(scan_code);
            ESP_LOGI(TAG, "     Sent   !!!!!!");
        }
        break;
